...
function renderProducts() {
    ...
    products.forEach((product, index) => {
        // Agregar condición para filtrar por categoría "brasil"
        if (product.category !== "brasil") {
            return; // Omitir este producto si no es de la categoría "brasil"
        }
        ...
        category.href = product.category;
